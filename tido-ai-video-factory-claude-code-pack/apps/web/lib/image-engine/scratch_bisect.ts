  ...
  products: [
    {
      ...
      likely_functions: [{ value: "DRINK", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      materials: [{ value: "GLASS", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      contents: [{ value: "MATCHA_MILK_TEA", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      surface_properties: [{ value: "TRANSPARENT", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      geometry_traits: [{ value: "CYLINDRICAL", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      packaging_types: [{ value: "BOTTLE", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      branding_features: [{ value: "TIDO_LOGO", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      visual_challenges: [],
      unknowns: [],
      retrieval_queries: [],
    },
    {
      ...
      industry_domains: [{ value: "F&B", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      likely_functions: [{ value: "DRINK", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      materials: [{ value: "PLASTIC", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      contents: [{ value: "BROWN_SUGAR_BOBA", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      surface_properties: [{ value: "TRANSPARENT", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      geometry_traits: [{ value: "CUP", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      packaging_types: [{ value: "CUP", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      branding_features: [{ value: "TIDO_LOGO", confidence: 1.0, evidence_type: "USER_PROVIDED", evidence_summary: "Test" }],
      visual_challenges: [],
      unknowns: [],
      retrieval_queries: [],
